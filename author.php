			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col-md-8 clearfix" role="main">
					...
					<div class="page-header"><h1 class="archive_title h2">
						<span><?php _e("Posts By:", "infinitum"); ?></span> 
						<?php 
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
							...
							<p class="meta"><?php _e("Posted", "infinitum"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_date(); ?></time> <?php _e("by", "infinitum"); ?> <?php the_author_posts_link(); ?> <span class="amp">&</span> <?php _e("filed under", "infinitum"); ?> <?php the_category(', '); ?>.</p>
					...
					<?php } else { // if it is disabled, display regular wp prev & next links ?>
						<nav class="wp-prev-next">
							<ul class="clearfix">
								<li class="prev-link"><?php next_posts_link(_e('&laquo; Older Entries', "infinitum")) ?></li>
								<li class="next-link"><?php previous_posts_link(_e('Newer Entries &raquo;', "infinitum")) ?></li>
							</ul>
						</nav>
					<?php } ?>
